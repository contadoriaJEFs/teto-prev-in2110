...
st.set_page_config(page_title='Extrator DIRF + Motor Previdenciário V1.2.37', page_icon='⚖️', layout='wide', initial_sidebar_state='expanded')
...
st.title('Extrator DIRF + Motor Previdenciário V1.2.37')
...
with tabs[6]:
    ...
    # Excel de conferência: espelho horizontal da extração documental, apenas dos
    # CNPJs selecionados. Os valores permanecem numéricos e sem R$ para permitir
    # cópia/cola direta em outras planilhas. Não mistura cálculos do motor.
