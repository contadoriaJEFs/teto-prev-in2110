...
st.set_page_config(page_title='Extrator DIRF + Motor Previdenciário V1.2.38', page_icon='⚖️', layout='wide', initial_sidebar_state='expanded')
...
st.title('Extrator DIRF + Motor Previdenciário V1.2.38')
...
with tabs[6]:
    ...
    with col_rel1:
        st.download_button(
            ...
            pdf_relatorio,
            'relatorio_apuracao_previdenciaria.pdf',
            'application/pdf',
    ...
    with col_rel2:
        ...
        st.download_button(
            ...
            excel_conferencia,
            'conferencia_dirfs_selecionadas.xlsx',
    ...
    st.download_button(
        ...
        'competencia_acima_do_teto.xlsx',
        'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet',
