...
st.set_page_config(page_title='Extrator DIRF + Motor Previdenciário V1.2.39', page_icon='⚖️', layout='wide', initial_sidebar_state='expanded')
...
st.title('Extrator DIRF + Motor Previdenciário V1.2.39')
